...
while read id; do
  ...
  #Downloading
  prefetch "$id"
  fasterq-dump "$id" --outdir ~/Multi-omics-analysis/01_rnaseq/fastq
  #Compressing
  gzip "$HOME/Multi-omics-analysis/01_rnaseq/fastq/${id}.fastq"
...
#Performing QC:
fastqc -t 4 -o ~/Multi-omics-analysis/01_rnaseq/fastqc_results/not_trimmed ~/Multi-omics-analysis/01_rnaseq/fastq/*.fastq.gz
#Merging QC results:
...
#Performing QC:
fastqc -t 4 -o ~/Multi-omics-analysis/01_rnaseq/fastqc_results/trimmed ~/Multi-omics-analysis/01_rnaseq/fastq_trimmed/*.fastq.gz
#Merging QC results:
